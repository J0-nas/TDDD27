  ...
  render() {
    return (
      <Grid className="glass" id="GameView">
        ...
        <div id="GameMechanic">
          <ProgressCounter onAnimationCounterHandle={this.props.AnimationCounterHandle} setStartAtHandle={this.props.addStartHandle}/>
          <div id="subpart">
            <TextBox artist={this.state.textBox.artist} title={this.state.textBox.title}/>
            <SolveInput onAnimationInputHandle={this.props.AnimationInputHandle} gvCB={this.inputSubmitCallback}/>
            <ProgressBar onAnimationBarHandle={this.props.AnimationBarHandle} setStartAtHandle={this.props.addStartHandle}/>
          </div>
        </div>
